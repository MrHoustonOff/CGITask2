...
import com.cgvsu.rasterizationfxapp.figure.Interpolation;
...
public class RasterizationController {
    ...
    private void initialize() {
        ...
        Interpolation.drawFilledOvalWithInterpolation(canvas.getGraphicsContext2D(), 0, 0, 500, 200, Color.RED, Color.BLUE);
